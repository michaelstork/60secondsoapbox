...
<template>
	<div class="submission-method">
		...
		<div class="submission-method-dialog">
			<button v-on:click="setSubmissionMethod('record')" class="submission-method-record-button" :disabled="!canRecordAudio" tabIndex="-1">
				<i class="mdi mdi-microphone" :class="{'mdi-microphone-off':!canRecordAudio}"></i>
				<span>Record my voice</span>
			</button>
			<span>Or</span>
			<button v-file-upload-link:audioUpload="setSelectedFile" class="submission-method-upload-button" tabIndex="-1">
